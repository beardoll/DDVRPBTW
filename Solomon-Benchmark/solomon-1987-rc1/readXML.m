...
savefilename = char(S(1));
save(savefilename, 'cx', 'cy', 'depotx', 'depoty', 'start_time', 'end_time', 'quantity', 'service_time', 'capacity', 'max_travel_time');

% 批量读取数据
dir C:\Users\cfinsBear\Documents\DDVRPBTW\Solomon-Benchmark\solomon-1987-rc1
list=dir(['F:\数据\','*.xls']);
k=length(list)
 for i=1:k
 ...
 save(filename, variables);  % filename可以指定路径
